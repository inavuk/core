...
class ListenerTest extends TestCase {
	...
	public function testCreateEvent() {
		...
		$this->assertArrayHasKey('uid', $calledCreateEvent[1]);
		$this->assertEquals('foo', $calledCreateEvent[1]->getArgument('uid'));
		$this->assertArrayHasKey('tagName', $calledCreateEvent[1]);
		$this->assertEquals('footag', $calledCreateEvent[1]->getArgument('tagName'));
	}
	...
	public function testUpdateEvent() {
		...
		$this->assertEquals('foo', $calledCreateEvent[1]->getArgument('uid'));
		$this->assertArrayHasKey('tagName', $calledCreateEvent[1]);
		$this->assertEquals('newfootag', $calledCreateEvent[1]->getArgument('tagName'));
		$this->assertArrayHasKey('oldTagName', $calledCreateEvent[1]);
		$this->assertEquals('footag', $calledCreateEvent[1]->getArgument('oldTagName'));
	}
